...
$(document).ready(function() {
    ...
    $("#mainDialog").dialog({ autoOpen: false, buttons: { "Close": function() { $(this).dialog("close"); } } });
...
function renderPattern(patternString)
{
    if (!haltDrawing)
    {
        resetGrid();
    ...
    if (!patternCompleted)
    {
        ...
        setTimeout(function(){ drawLogo(patternString); }, 10);
        return;
    }   

    importPattern(patternString);
    startAutoDraw();
}
